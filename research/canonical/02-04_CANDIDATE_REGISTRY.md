...
| C011 | Precision-screen reliability versus geographic coverage in HUD Qualified Census Tract designation | **SURVIVES / NARROWED EXACT-YEAR PAPER / FIRST-PAPER PRIORITY RETAINED** | Four prospectively admitted exact years show recurring population-selective eligibility loss and nonlocal cap-mediated designation effects; decade representativeness is unavailable because the frozen 7/10 reconstruction gate failed |
